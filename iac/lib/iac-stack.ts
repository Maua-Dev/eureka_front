...
export class IacStack extends cdk.Stack {
  constructor(scope: Construct, id: string,  props?: cdk.StackProps) {
    ...
    const alternativeDomain = process.env.ALTERNATIVE_DOMAIN_NAME || 'eureka-dev.devmaua.com';
    const hostedZoneIdValue = process.env.HOSTED_ZONE_ID || 'Z1UJRXOUMOOFQ8';

    const s3Bucket = new s3.Bucket(this, 'EurekaFrontBucket' + stage, {
      versioned: true,
    ...
    const cloudFrontWebDistribution = new cloudfront.CloudFrontWebDistribution(this, 'CDN', {
      ...
      viewerCertificate: cloudfront.ViewerCertificate.fromAcmCertificate(
        Certificate.fromCertificateArn(this, 'EurekaFrontCertificate-' + stage, acmCertificateArn),
        {
    ...
    const zone = route53.HostedZone.fromHostedZoneAttributes(this, 'EurekaFrontHostedZone-' + stage, {
      hostedZoneId: hostedZoneIdValue,
      zoneName: alternativeDomain,
    });
    
    new route53.ARecord(this, 'EurekaFrontAliasRecord-' + stage, {
      zone: zone,
    ...
    new cdk.CfnOutput(this, 'EurekaFrontBucketName-' + stage, {
      value: s3Bucket.bucketName,
    });

    new cdk.CfnOutput(this, 'EurekaFrontDistributionId-' + stage, {
