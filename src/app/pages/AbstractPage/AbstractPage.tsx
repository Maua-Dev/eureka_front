...
export default function AbstractPage() {
    ...
    const abstractsFromContext = deliveryFromContext?.content[
        "abstract"
    ] as AbstractType;

    const [abstract, setAbstract] =
        useState<AbstractType>(abstractsFromContext);
    ...
    useEffect(() => {
        if (
            abstractsFromContext?.title != null &&
            title !== abstractsFromContext.title
        ) {
    ...
    useEffect(() => {
        if (
            abstractsFromContext?.keyWords != null &&
            keywords !== abstractsFromContext.keyWords
        ) {
    ...
    const handleSendButtonClick = () => {
        ...
        if (
            ...
            toast.error(
                "Preencha os campos de título e/ou resumo e/ou palavras chave"
            );
            hasError = true;
        }
    ...
    const abstractFromContextENG = deliveryFromContext?.content[
        "abstractENG"
    ] as AbstractType;

    const [abstractENG, setAbstractENG] = useState<AbstractType>(
    ...
    useEffect(() => {
        if (
            abstractFromContextENG?.title != null &&
            titleENG !== abstractFromContextENG.title
        ) {
                    ...
                    >
                        <div className="box__main">
                            <span className="box__span">
                                Envio do resumo corrigido. As palavras em ingês
                                devem estar isoladas com aspas. Tudo deve ser
                                preenchido em <u>português</u>.
                            </span>
                            <div>
                                <DefaultTextField
                                    setValue={setTitle}
                                    ...
                                    onSaveClick={() => {
                                        if (title === "") {
                                            ...
                                            toast.error(
                                                "O título do projeto não pode ser igual ao anterior"
                                            );
                                        } else {
                                            handleFetch(
                                                setIsLoading,
                                ...
                                ></DefaultTextField>
                                <span className="box__span">
                                    Título do trabalho após apresentação para
                                    banca. Lembrando que ao salvar o título ele
                                    se torna definitivo.
                                </span>
                            </div>
                            <div>
                                ...
                                ></DefaultTextField>
                                <span className="box__span">
                                    Resumo do trabalho após apresentação para
                                    banca. Lembrando que ao salvar o resumo ele
                                    se torna definitivo.
                                </span>
                            </div>
                            <div>
