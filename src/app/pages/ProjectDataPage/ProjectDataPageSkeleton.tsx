            ...
            >
                <div className="box__main">
                    ...
                    <span className="box__span">
                        ...
                        uma agenda mundial adotada durante a Cúpula das Nações
                        Unidas sobre o Desenvolvimento Sustentável em setembro
                        de 2015 composta por 17 objetivos e 169 metas a serem
                        atingidos até 2030. Para saber mais veja a tela de{" "}
                        <Link
                            className="box__span"
                            target="_blank"
                            to={
