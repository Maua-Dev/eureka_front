...
import ControlledTextFieldSkeleton from "@components/ControlledTextField/ControlledTextFieldSkeleton";
            ...
            >
                <div className="box__main">
                    <div className="subject subject--skeleton">
                        <h2 className="main__title main__title--skeleton">
                            Habilitação:{" "}
                        </h2>
                    ...
                    <div className="students students--skeleton">
                        <h2 className="main__title main__title--students main__title--skeleton">
                            Alunos:{" "}
                        </h2>
                        <Skeleton
                    ...
                    <footer className="box__footer">
                        ...
                        <div className="potencial">
                            <h2 className="main__title">
                                O trabalho tem potencial para empreendimento:{" "}
                            </h2>
