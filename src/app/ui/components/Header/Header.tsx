...
import { navOptionsList } from "@constants/nav-options-list";
                ...
                <div className="container--left">
                    <Link className="logo" to={""}>
                        <img
                            className="logo__img"
                            src={mauaLogo}
                            alt="Logo do Instituto Mauá de Tecnologia"
                        />
                    </Link>
            ...
            <nav className="header--botton">
                ...
                <aside className="squares">
                    ...
                    <DismissableDialog
                        ...
                        setOpen={setIsMenuColumnOpen}
                    >
                        <img
                            className="menu__img"
                            onClick={() =>
                                setIsMenuColumnOpen(!isMenuColumnOpen)
                            }
                            src={menuIcon}
                            alt="ìcone de menu"
                        />
